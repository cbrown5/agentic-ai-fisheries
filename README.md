...
See the companion repo cbrown5/agentic-ai-fisheries-results for results of the AI agent runs including scripts to create plots of results for the paper. Data in this folder contains just the case studies and the validation of the case studies. 
