...
Overall both LLMs showed high aptitude at completing the range of tasks we set, but consistency varied across the replicates (fig. 2). In many cases all tasks were completed accurately (fig. 2a, b, d), but there were also many cases of the agents creating apparently valid results that were inaccurate (fig. 2c, e) as we will now discuss for each case study.
