...
Large language models (LLMs) and agentic AI offer a transformative opportunity to automate complex fisheries modelling workflows [@bistarelli2025]. By separating code creation from model design and data acquisition, these technologies will lower the technical barriers for non-experts [@jansen2025leveraging]. For experts, LLMs are particularly valuable in streamlining routine coding tasks, enhancing efficiency, and reducing errors, thereby freeing time for higher-level model design and scientific reasoning [@Chen2023]. For instance, AI-generated code has been applied in biological pest control distribution modelling [@scheepens2024], and in the autonomous synthesis of insect repellents [@bran2024], reducing development time and errors. The ability of LLMs to automate code generation means that generative AI will become a pervasive modelling tool [@cooper2024], however, the reliability and quality of AI-generated code remain uncertain [@wills2024; @johnson2024]. For example, LLMs can create believable but fictitious information [@scheepens2024], or produce code that executes but is logically flawed [@hocky2022; @jansen2025leveraging]. Thus, to effectively use LLM for coding, users need to be familiar enough with the programming language to detect anomalies in AI outputs [@cooper2024]. Evaluation of LLM output against standardized examples therefore plays an important role in determining the boundaries of appropriate use. Evaluations of coding tools are particularly imperative in fisheries science where results are often used to inform contentious management decisions. Guidelines for the performance of LLMs are needed to inform fisheries scientists about (A) what tasks can be completed with LLMs and (B) how can LLMs best be used to facilitate accurate fisheries modelling.
