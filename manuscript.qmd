...
When starting out a fisheries modeller won't have fully informed instructions. These take time to write. We have shown that well worded instructions have an element of repeatability, in that results are reasonably consistent. AI agents show varying performance when tasked linguistically with managing a diverse range of fisheries models that vary in complexities and difficulty. 
