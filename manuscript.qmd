...
Kimi was lazy, often not completing reports (e.g. in run13) or didn't do as instructed (e.g. used wrong ggplot theme.), or run15 it wrote code for plots (which worked) but didn't complete the task. 
Kimi often 'lied' e.g. run 14 said it had completed final report, but there was none. 
